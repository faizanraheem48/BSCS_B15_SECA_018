...
import './iPhone1212Pro20.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class iPhone1212Pro26 extends StatelessWidget {
  iPhone1212Pro26({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 30.0, middle: 0.5995),
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(15.0),
                color: const Color(0xff32cbe9),
              ),
            ),
          ),
          Pinned.fromPins(
            Pin(size: 61.0, start: 25.0),
            Pin(size: 30.0, middle: 0.5369),
            child: Container(
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(15.0),
                color: const Color(0xffffffff),
          ...
          Pinned.fromPins(
            Pin(size: 109.0, end: 1.0),
            Pin(size: 115.0, start: 12.0),
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0xffffffff),
              ),
          ...
          Pinned.fromPins(
            Pin(size: 66.0, end: 40.0),
            Pin(size: 85.0, start: 21.0),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.linear,
                  duration: 0.3,
                  pageBuilder: () => iPhone1212Pro20(),
                ),
              ],
              child: Stack(
                children: <Widget>[
