...
import './iPhone1212Pro3.dart';
import 'package:adobe_xd/page_link.dart';
import './iPhone1212Pro1.dart';
import 'package:flutter_svg/flutter_svg.dart';

class iPhone1212Pro2 extends StatelessWidget {
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            ...
            Pin(size: 45.0, middle: 0.4931),
            child: PageLink(
              links: [
                PageLinkInfo(
                  duration: 0,
                  pageBuilder: () => iPhone1212Pro3(),
                ),
              ],
              child: Container(
          ...
          Pinned.fromPins(
            Pin(size: 145.0, middle: 0.5102),
            Pin(size: 40.0, middle: 0.3968),
            child: Text(
              'Categories',
              style: TextStyle(
                fontFamily: 'Segoe UI',
