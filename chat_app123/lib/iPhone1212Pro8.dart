...
class iPhone1212Pro8 extends StatelessWidget {
  iPhone1212Pro8({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_369u0b =
    '<svg viewBox="25.7 18.0 27.0 18.0" ><path transform="translate(21.2, 9.0)" d="M 4.5 27 L 31.5 27 L 31.5 24 L 4.5 24 L 4.5 27 Z M 4.5 19.5 L 31.5 19.5 L 31.5 16.5 L 4.5 16.5 L 4.5 19.5 Z M 4.5 9 L 4.5 12 L 31.5 12 L 31.5 9 L 4.5 9 Z" fill="#fff2f2" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
