...
import './iPhone1212Pro15.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class iPhone1212Pro9 extends StatelessWidget {
  iPhone1212Pro9({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: Container(
              decoration: BoxDecoration(
                color: const Color(0x800a0909),
              ),
            ),
          ),
          Pinned.fromPins(
            Pin(start: 39.0, end: 38.0),
            Pin(size: 275.0, middle: 0.5009),
            child: Container(
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 26.0, middle: 0.7692),
            Pin(size: 26.0, middle: 0.5941),
            child: PageLink(
              links: [
                PageLinkInfo(
                  ease: Curves.linear,
                  duration: 0.3,
                  pageBuilder: () => iPhone1212Pro15(),
                ),
              ],
              child: Text(
                'OK',
